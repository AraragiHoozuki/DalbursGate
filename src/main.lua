...
CreateUnit(Player(1), FourCC('nbt1'), -1500, 90, 293)
CreateUnit(Player(1), FourCC('ntt1'), -500, 90, 293)
CreateUnit(Player(1), FourCC('net1'), 500, 90, 293)
CreateUnit(Player(1), FourCC('nft1'), 1500, 90, 293)
